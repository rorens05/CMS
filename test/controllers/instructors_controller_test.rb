...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { hire_date: @instructor.hire_date, other_information: @instructor.other_information, user_id: @instructor.user_id } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { hire_date: @instructor.hire_date, other_information: @instructor.other_information, user_id: @instructor.user_id } }
