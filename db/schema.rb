...
ActiveRecord::Schema.define(version: 2019_01_28_034716) do
  ...
  create_table "attendance_details", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "class_enrollments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "student_id"
    t.integer "subject_class_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
